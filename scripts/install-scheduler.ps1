...
# Sets up Windows Task Scheduler jobs for Ship While You Sleep
#
...
$ScriptsDir = "C:\ship_asleep\scripts"
...
if (-not (Test-Path $ScriptsDir)) {
    Write-Error "Ship Asleep scripts not found at: $ScriptsDir"
    exit 1
}

Write-Host "Ship While You Sleep - Scheduler Setup" -ForegroundColor Cyan
...
Register-ScheduledTask `
    ...
    -Description "Ship While You Sleep: Extract learnings from today's Claude Code sessions" `
    | Out-Null
...
Register-ScheduledTask `
    ...
    -Description "Ship While You Sleep: Implement #1 priority and create PR" `
    | Out-Null
...
Register-ScheduledTask `
    ...
    -Description "Ship While You Sleep: Keep system awake during automation window" `
    | Out-Null
