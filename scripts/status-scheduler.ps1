...
# Shows status of Ship While You Sleep scheduled tasks
#
# Usage: .\status-scheduler.ps1 [-TaskPrefix "ShipAsleep"]

param(
    [string]$TaskPrefix = "ShipAsleep"
)

Write-Host "Ship While You Sleep - Scheduler Status" -ForegroundColor Cyan
